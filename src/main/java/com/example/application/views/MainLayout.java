...
import com.example.application.views.byteachers.ByTeachersView;
import com.example.application.views.bydiscipline.ByDisciplineView;
import com.example.application.views.bystudentgroup.ByStudentGroupView;
import com.example.application.views.byclass.ByClassView;
import com.example.application.views.enter.EnterView;
...
public MainLayout(AuthenticatedUser authenticatedUser, AccessAnnotationChecker accessChecker) {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Расписание занятий");
...
new MenuItemInfo("по Предметам", "la la-file", ByDisciplineView.class), //
